...
function testNextLineFromIndex0() {
    ...
    assertEquals("Buffer position after first next line", 4, mockEjax.ejax.screen.currentBuffer.cursor);
    mockEjax.ejax.nextLine();
    assertEquals("Buffer position after second next line", 8, mockEjax.ejax.screen.currentBuffer.cursor);
    mockEjax.ejax.nextLine();
    assertEquals("Buffer position after third next line", 12, mockEjax.ejax.screen.currentBuffer.cursor);
}
...
function testNextLineFromIndex1() {
    ...
    mockEjax.ejax.nextLine();
    assertEquals("Buffer position after first next line", 5, mockEjax.ejax.screen.currentBuffer.cursor);
    mockEjax.ejax.nextLine();
    assertEquals("Buffer position after second next line", 9, mockEjax.ejax.screen.currentBuffer.cursor);
    mockEjax.ejax.nextLine();
    assertEquals("Buffer position after third next line", 12, mockEjax.ejax.screen.currentBuffer.cursor);
}
...
function testNextLineFromIndex0WithVariedLines() {
    ...
    assertEquals("Buffer position after first next line", 4, mockEjax.ejax.screen.currentBuffer.cursor);
    mockEjax.ejax.nextLine();
    assertEquals("Buffer position after second next line", 5, mockEjax.ejax.screen.currentBuffer.cursor);
    mockEjax.ejax.nextLine();
    assertEquals("Buffer position after third next line", 9, mockEjax.ejax.screen.currentBuffer.cursor);
}
...
function testNextLineFromIndex1WithVariedLines() {
    ...
    assertEquals("Buffer position after first next line", 5, mockEjax.ejax.screen.currentBuffer.cursor);
    mockEjax.ejax.nextLine();
    assertEquals("Buffer position after second next line", 7, mockEjax.ejax.screen.currentBuffer.cursor);
    mockEjax.ejax.nextLine();
    assertEquals("Buffer position after third next line", 8, mockEjax.ejax.screen.currentBuffer.cursor);
    mockEjax.ejax.nextLine();
    assertEquals("Buffer position after fourth next line", 12, mockEjax.ejax.screen.currentBuffer.cursor);
}

function testNextLineWithNewlinesAtTheBeginning() {
    mockEjax.ejax.setBufferContent("\n\n\nabc\n");
    mockEjax.ejax.nextLine();
    assertEquals("Buffer position after first next line", 1, mockEjax.ejax.screen.currentBuffer.cursor);
    mockEjax.ejax.nextLine();
    assertEquals("Buffer position after second next line", 2, mockEjax.ejax.screen.currentBuffer.cursor);
    mockEjax.ejax.nextLine();
    assertEquals("Buffer position after third next line", 3, mockEjax.ejax.screen.currentBuffer.cursor);
    mockEjax.ejax.nextLine();
    assertEquals("Buffer position after fourth next line", 7, mockEjax.ejax.screen.currentBuffer.cursor);
}
...
function testNextLineWithNoNewlinesAtTheEnd() {
    ...
    assertEquals("Buffer position after third next line", 3, mockEjax.ejax.screen.currentBuffer.cursor);
    mockEjax.ejax.nextLine();
    assertEquals("Buffer position after fourth next line", 6, mockEjax.ejax.screen.currentBuffer.cursor);
}
...
function testPreviousLineFromFirstCharacterOfLastLine() {
    ...
    assertEquals("Buffer position after first previous line", 8, mockEjax.ejax.screen.currentBuffer.cursor);
    mockEjax.ejax.previousLine();
    assertEquals("Buffer position after second previous line", 4, mockEjax.ejax.screen.currentBuffer.cursor);
    mockEjax.ejax.previousLine();
...
function testPreviousLineFromSecondCharacterOfLastLine() {
    ...
    mockEjax.ejax.previousLine();
    assertEquals("Buffer position after first previous line", 5, mockEjax.ejax.screen.currentBuffer.cursor);
    mockEjax.ejax.previousLine();
    assertEquals("Buffer position after second previous line", 1, mockEjax.ejax.screen.currentBuffer.cursor);
    mockEjax.ejax.previousLine();
    assertEquals("Buffer position after third previous line", 0, mockEjax.ejax.screen.currentBuffer.cursor);
}
...
function testPreviousLineWithNewlinesAtBeginning() {
    ...
    mockEjax.ejax.previousLine();
    assertEquals("Buffer position after first previous line", 4, mockEjax.ejax.screen.currentBuffer.cursor);
    mockEjax.ejax.previousLine();
    assertEquals("Buffer position after secon previous line", 3, mockEjax.ejax.screen.currentBuffer.cursor);
    mockEjax.ejax.previousLine();
    assertEquals("Buffer position after third previous line", 2, mockEjax.ejax.screen.currentBuffer.cursor);
    mockEjax.ejax.previousLine();
    assertEquals("Buffer position after fourth previous line", 1, mockEjax.ejax.screen.currentBuffer.cursor);
    mockEjax.ejax.previousLine();
    assertEquals("Buffer position after fifth previous line", 0, mockEjax.ejax.screen.currentBuffer.cursor);
}
...
function testPreviousLineWithNewlinesAfterFirstLine() {
    ...
    mockEjax.ejax.previousLine();
    assertEquals("Buffer position after first previous line", 7, mockEjax.ejax.screen.currentBuffer.cursor);
    mockEjax.ejax.previousLine();
    assertEquals("Buffer position after secon previous line", 6, mockEjax.ejax.screen.currentBuffer.cursor);
    mockEjax.ejax.previousLine();
    assertEquals("Buffer position after third previous line", 5, mockEjax.ejax.screen.currentBuffer.cursor);
    mockEjax.ejax.previousLine();
    assertEquals("Buffer position after fourth previous line", 4, mockEjax.ejax.screen.currentBuffer.cursor);
    mockEjax.ejax.previousLine();
    assertEquals("Buffer position after fifth previous line", 0, mockEjax.ejax.screen.currentBuffer.cursor);
}
...
function testEmptyLineThenTwoLinesWithText() {
    ...
    assertEquals("Buffer position after first previous line", 7, mockEjax.ejax.screen.currentBuffer.cursor);
    mockEjax.ejax.previousLine();
    assertEquals("Buffer position after secon previous line", 4, mockEjax.ejax.screen.currentBuffer.cursor);
    mockEjax.ejax.previousLine();
    assertEquals("Buffer position after third previous line", 0, mockEjax.ejax.screen.currentBuffer.cursor);
}
